...
function EmailAutoComplete(options) {
	this.config = {
		...
		mailArr: ["@qq.com", "@gmail.com", "@126.com", "@163.com", "@139.com", "@hotmail.com", "@yahoo.com", "@yeah.com", "@yahoo.com.cn", "@live.com", "@sohu.com", "@sina.com", ], //邮箱数组
	...
	_keyUpAndDown: function (targetVal, e, parentNode) {
		...
		if ($('.auto-tip' + ' li', parentNode) && $('.auto-tip' + ' li').length > 0) {
			...
			if (keyCode == 38) {
				...
				var curVal = $('.auto-tip' + ' .p-index' + Math.max(_cache.oldIndex, 0), parentNode).attr('data-html');
